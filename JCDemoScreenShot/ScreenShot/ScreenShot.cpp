...
void ScreenShot::saveFullScreen()
{
...
void ScreenShot::saveScreenOther()
{
...
void ScreenShot::mouseReleaseEvent(QMouseEvent *)
{
    if (screen->getStatus() == Screen::SELECT) {
